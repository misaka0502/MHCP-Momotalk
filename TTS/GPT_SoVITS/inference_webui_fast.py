...
sys.path.append("%s/TTS/GPT_SoVITS" % (now_dir))
...
def inference(tts_pipeline, text, text_lang, 
              ref_audio_path, 
              aux_ref_audio_paths,
              prompt_text, 
              prompt_lang, top_k, 
...
SoVITS_weight_root=["TTS/SoVITS_weights_v2","TTS/SoVITS_weights"]
GPT_weight_root=["TTS/GPT_weights_v2","TTS/GPT_weights"]
