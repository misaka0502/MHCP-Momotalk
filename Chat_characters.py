...
class Momotalk(genai.GenerativeModel):
    def __init__(self, character):
        ...
        with open(f"characters_config/{character}.yaml", "r") as f:
    ...
    def get_prompt(self, character):
        ...
        prompt = common_prompt + character_prompt + feature_prompt + experience_prompt + quote_prompt + \
            "\n以上是我提供的设定和台词，请你遵照这些设定、萌点，重点是模仿这些台词来扮演角色并用中文与我对话、回答我的问题。注意使用中文！注意使用中文！注意使用中文！回复不要有太多省略号。不要太过标签化。" + \
            "同时，如果你的回答里面有数学符号，请用中文表达。"
        return prompt
    ...
    def speech(self, text):
        ...
        save_audio(audio_data, f"/home/yumio/Code/MHCP_Momotalk/TTS/TTS_output/yuuka/yuuka.wav")
        return audio_data
